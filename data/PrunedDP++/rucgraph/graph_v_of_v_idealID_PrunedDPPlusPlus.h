...
graph_hash_of_mixed_weighted graph_v_of_v_idealID_PrunedDPPlusPlus(graph_v_of_v_idealID& input_graph, graph_v_of_v_idealID& group_graph, std::unordered_set<int>& cumpulsory_group_vertices, int maximum_return_app_ratio, int& RAM_MB,int *pointer2,bool& find) {
	...
	// getchar();
	find=false;
	graph_hash_of_mixed_weighted empty;
	return empty;
